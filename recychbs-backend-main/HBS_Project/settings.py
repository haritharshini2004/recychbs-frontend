...
ALLOWED_HOSTS = ['https://backend.recychbs.com']
...
# settings.py
AUTHENTICATION_BACKENDS = [
    'CustomUser.backends.EmailBackend',  # Custom backend
    'django.contrib.auth.backends.ModelBackend',
  
    # 'CustomUser.backends.EmailBackend',  # Adjust to match your app name
    # 'django.contrib.auth.backends.ModelBackend'
]
...
CORS_ALLOWED_ORIGINS = [
    ...
    'https://www.recychbsadmin.in', 
    'https://backend.recychbs.in',
...
# settings.py (Django)
FRONTEND_URL = "'www.app.recychbs.in"  # Set this to your actual frontend URL
